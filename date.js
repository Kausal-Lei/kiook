...
function dateshow(){
	$("#datePlugin").fadeIn(300);
}
function datehide(){
	$("#datePlugin").fadeOut(300);
}
...
(function ($) {      
    $.fn.date = function (options,Ycallback,Ncallback) {   
        ...
        var initY=parseInt((nowdate.getFullYear()))-2000;
        ...
        var yearScroll=null,monthScroll=null,dayScroll=null,hhScroll=null;
        ...
        function refreshDate(){
			...
			hhScroll.scrollTo(0, initH*50-50, 100, true); 
        }
        ...
        function bindButton(){
            ...
            $("#dateconfirm").unbind('click').click(function () {	
			  ...
			  $("#hhwrapper ul li:eq("+Math.round(indexH)+")").html().substr(0,$("#hhwrapper ul li:eq("+Math.round(indexH)+")").html().length-1)+":00";
        ...
        function init_iScrll() {
			...
			var strM=0;           
                       ...
                       opts.endday = checkdays(strY,strM);
						  ...
						  $("#hhwrapper ul").html(createHH_UL());
                           dayScroll.refresh();    
							...
							$("#hhwrapper").find("li").eq(crentHHindex).addClass("crently").siblings().removeClass("crently"); 
			  ...
			  hhScroll = new iScroll("hhwrapper",{snap:"li",vScrollbar:false,
			      onScrollEnd:function () {
			          indexH = (this.y/50)*(-1)+1;
			      }});
        }
        ...
        function addTimeStyle(){
			...
			$("#hhwrapper").css("position","absolute");
			$("#hhwrapper").css("bottom","200px");
        }
        //创建 --年-- 列表
